# Maja comment: There is no translation of a function,
# which makes it possible to access a certain index of list 
# Therefor I used listOfStudentTuples.sort(key=operator.itemgetter(0))
# instead in 04_Grades.py
